import { getGlobalClassNames, getFocusStyle, HighContrastSelector } from 'office-ui-fabric-react/lib/Styling';
import { IDefaultTagItemStyleProps, ITagItemStyles } from './DefaultTagItem.types';
...
export function getStyles(props: IDefaultTagItemStyleProps): ITagItemStyles {
