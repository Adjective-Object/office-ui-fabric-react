...
export type IUnifiedPickerComponent = IComponent<IUnifiedPickerProps, IUnifiedPickerTokens, IUnifiedPickerStyles, IUnifiedPickerViewProps>;
...
export interface IUnifiedPickerProps
  extends IUnifiedPickerSlots,
