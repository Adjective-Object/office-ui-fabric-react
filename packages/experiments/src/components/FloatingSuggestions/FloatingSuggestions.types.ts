...
import { IBaseProps } from '../../../../utilities/lib';
...
export interface IFloatingSuggestionsProps<T> extends IBaseProps {
  componentRef?: React.RefObject<IFloatingSuggestions<T>>;
  /**
